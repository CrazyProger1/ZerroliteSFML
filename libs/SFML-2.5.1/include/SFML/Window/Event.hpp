...
public:
    ...
    enum EventType
    {
        ...
        MouseMoved,             ///< The mouse m_cursor moved (data in event.mouseMove)
        MouseEntered,           ///< The mouse m_cursor entered the area of the window (no data)
        MouseLeft,              ///< The mouse m_cursor left the area of the window (no data)
